		...
		<div class="formWrapper">
			<form action="../classes/formValue.php" method="POST">
				...
				<label for="firstName">First Name
					...
					<input type="text" name="firstName" value="<?php echo $value['firstName']; ?>">
				</label>
				<label for="lastName">Last Name
					<input type="text" name="lastName" value="<?php echo $value['lastName']; ?>">
				</label>
				<label for="email">Email
					<input type="text" name="email" id="email" value="<?php echo $value['email']; ?>" disabled>
				</label>
				<label for="licenseNo">License Number
